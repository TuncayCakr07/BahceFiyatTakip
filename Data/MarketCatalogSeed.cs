...
internal static class MarketCatalogSeed
{
    ...
    [
        ...
        new(@"Web Arama", @"https://www.bing.com", null, true),
        ...
        new(@"Avokadocu Ayşe", @"https://www.avokadocuayse.com", null, false),
        ...
        new(@"Büyükannem", @"https://www.buyukannem.com", null, false),
        ...
        new(@"Eski Tadında", @"https://www.eskitadinda.com", null, false),
        ...
        new(@"Gülen Bahçe", @"https://www.gulenbahce.com", null, false),
        ...
        new(@"Nuribeyçiftliği", @"https://www.nuribeyciftligi.com", null, false),
        ...
        new(@"Sebzemeyvedünyası", @"https://www.sebzemeyvedunyasi.com", null, false),
        ...
        new(@"Solmera Çiftliği", @"https://www.solmeraciftligi.com", @"https://www.solmeraciftligi.com/?s={0}", true),
        ...
        new(@"Taze Masa", @"https://www.tazemasa.com", null, false),
        ...
        new(@"Tropiksepeti", @"https://www.tropiksepeti.com", null, false),
        new(@"Turkuazköy", @"https://www.turkuazkoy.com", @"https://www.turkuazkoy.com/?s={0}", true),
        new(@"Turuncubag", @"https://www.turuncubag.com", null, false),
        ...
        new(@"Sahiden Organik", @"https://sahidenorganik.com", null, false),
